define(['dart_sdk', 'packages/angular_router/angular_router.template'], function(dart_sdk, angular_router) {
  ...
  dart.trackLibraries("packages/isowosi_angular_components/src/routes.template.ddc", {
    "package:isowosi_angular_components/src/routes.template.dart": src__routes$46template
