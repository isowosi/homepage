define(['dart_sdk', 'packages/angular/src/facade/exception_handler.template'], function(dart_sdk, exception_handler) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["facade.template.dart"],"names":[],"mappings":";;;;;;;;;MASI,uCAAQ;YAAG;;;;;AAEb,kBAAI,uCAAQ,GAAE;AACZ;;AAEF,8CAAW;AAEX,IAAM,uDAAa;EACrB","file":"facade.template.ddc.js"}');
  // Exports:
  return {
