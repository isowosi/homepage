define(['dart_sdk', 'packages/angular/src/platform/browser/exceptions', 'packages/angular/src/di/reflector', 'packages/angular/core.template'], function(dart_sdk, exceptions, reflector, core) {
  'use strict';
