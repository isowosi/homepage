define(['dart_sdk', 'packages/angular/src/platform/browser/tools/common_tools.template', 'packages/angular/src/core/change_detection/host.template'], function(dart_sdk, common_tools, host) {
  'use strict';
