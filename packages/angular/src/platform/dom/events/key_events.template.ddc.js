define(['dart_sdk', 'packages/angular/src/platform/dom/events/key_events', 'packages/angular/src/di/reflector', 'packages/angular/src/platform/dom/events/event_manager.template', 'packages/angular/src/core/di.template', 'packages/angular/src/runtime.template'], function(dart_sdk, key_events, reflector, event_manager, di, runtime) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["key_events.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;MAgBI,0DAAQ;YAAG;;;;;AAEb,kBAAI,0DAAQ,GAAE;AACZ;;AAEF,iEAAW;AAEX,IAAO,kCAAe,CAAC,qEAAe,EAAE,cAAM,IAAI,0DAAe;AACjE,IAAM,kEAAa;AACnB,IAAM,sCAAa;AACnB,IAAM,qCAAa;EACrB","file":"key_events.template.ddc.js"}');
  // Exports:
  return {
