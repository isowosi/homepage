define(['dart_sdk', 'packages/angular/src/runtime/optimizations', 'packages/angular/src/platform/dom/events/event_manager'], function(dart_sdk, optimizations, event_manager) {
  'use strict';
