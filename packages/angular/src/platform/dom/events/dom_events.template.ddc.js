define(['dart_sdk', 'packages/angular/src/platform/dom/events/dom_events', 'packages/angular/src/di/reflector', 'packages/angular/src/platform/dom/events/event_manager.template', 'packages/angular/di.template'], function(dart_sdk, dom_events, reflector, event_manager, di) {
  'use strict';
