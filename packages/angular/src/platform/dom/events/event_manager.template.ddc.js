define(['dart_sdk', 'packages/angular/src/platform/dom/events/event_manager', 'packages/angular/src/core/zone/ng_zone', 'packages/angular/src/di/reflector', 'packages/angular/src/core/di/opaque_token', 'packages/angular/src/core/di/decorators', 'packages/angular/src/core/di.template', 'packages/angular/src/core/zone/ng_zone.template'], function(dart_sdk, event_manager, ng_zone, reflector, opaque_token, decorators, di, ng_zone$) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["event_manager.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;MAgBI,6DAAQ;YAAG;;;;;;;;;;AAEb,kBAAI,6DAAQ,GAAE;AACZ;;AAEF,oEAAW;AAEX,IAAO,kCAAe,CAAC,qEAAY,EAAE,SAAC,EAA+B,EAAE,EAAa,KAAK,IAAI,0DAAY,CAAC,EAAE,EAAE,EAAE;AAChH,IAAO,uCAAoB,CAAC,qEAAY,EAAE,sCACxC,sCAAO,qCAAM,oCAAa,CAAC,mCAAM,2CAAwB,CAAC,6CAC1D,sCAAW,8CAAM;AAEnB,IAAM,sCAAa;AACnB,IAAM,iDAAa;EACrB","file":"event_manager.template.ddc.js"}');
  // Exports:
  return {
