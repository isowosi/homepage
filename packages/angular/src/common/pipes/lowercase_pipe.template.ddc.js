define(['dart_sdk', 'packages/angular/src/common/pipes/invalid_pipe_argument_exception.template', 'packages/angular/di.template'], function(dart_sdk, invalid_pipe_argument_exception, di) {
  ...
  dart.trackLibraries("packages/angular/src/common/pipes/lowercase_pipe.template.ddc", {
    "package:angular/src/common/pipes/lowercase_pipe.template.dart": src__common__pipes__lowercase_pipe$46template
  }, '{"version":3,"sourceRoot":"","sources":["lowercase_pipe.template.dart"],"names":[],"mappings":";;;;;;;;;;MAYI,sDAAQ;YAAG;;;;;AAEb,kBAAI,sDAAQ,GAAE;AACZ;;AAEF,6DAAW;AAEX,IAAM,4EAAa;AACnB,IAAM,2BAAa;EACrB","file":"lowercase_pipe.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=lowercase_pipe.template.ddc.js.map
