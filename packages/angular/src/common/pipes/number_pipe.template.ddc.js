define(['dart_sdk', 'packages/angular/src/common/pipes/invalid_pipe_argument_exception.template', 'packages/angular/di.template'], function(dart_sdk, invalid_pipe_argument_exception, di) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["number_pipe.template.dart"],"names":[],"mappings":";;;;;;;;;;MAaI,mDAAQ;YAAG;;;;;AAEb,kBAAI,mDAAQ,GAAE;AACZ;;AAEF,0DAAW;AAEX,IAAM,4EAAa;AACnB,IAAM,2BAAa;EACrB","file":"number_pipe.template.ddc.js"}');
  // Exports:
  return {
