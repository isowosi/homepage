define(['dart_sdk', 'packages/angular/src/common/pipes/invalid_pipe_argument_exception', 'packages/angular/src/core/change_detection/pipe_transform'], function(dart_sdk, invalid_pipe_argument_exception, pipe_transform) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["slice_pipe.dart"],"names":[],"mappings":";;;;;;;;;;;;;cAuDoB,KAAa,EAAE,KAAS,EAAG,GAAO;0BAAH;AAC/C,qBAAK,aAAa,CAAC,KAAK,IAAG;AACzB,mBAAM,IAAI,oFAA4B,CAAC,uDAAS,EAAE,KAAK;;AAEzD,UAAI,KAAK,IAAI,MAAM,MAAO,MAAK;AAI/B,UAAI,gCAAS,KAAK;AAClB,WAAK,GAAG,AAAM,aAAN,KAAK,IAAG,IAAI,AAAK,QAAG,WAAC,GAAU,aAAP,MAAM,iBAAG,KAAK,KAAI,AAAK,QAAG,WAAC,KAAK,EAAE,MAAM;AACxE,UAAI,GAAG,IAAI,MAAM;AACf,WAAG,GAAG,AAAI,aAAJ,GAAG,IAAG,IAAI,AAAK,QAAG,WAAC,GAAU,aAAP,MAAM,iBAAG,GAAG,KAAI,AAAK,QAAG,WAAC,GAAG,EAAE,MAAM;AAChE,YAAQ,aAAJ,GAAG,iBAAG,KAAK,GAAE,cAAO,KAAK,eAAa,KAAK;;AAEjD,iBAAI,KAAK,cAAY;AACnB,cAAO,MAAK,YAAU,CAAC,KAAK,EAAE,GAAG;YAC5B,kBAAI,KAAK,GAAU;AACxB,cAAO,MAAK,UAAQ,CAAC,KAAK,EAAE,GAAG;aAC1B;AACL,cAAO;;IAEX;aAEc,GAAW;YAAmB,QAAd,GAAG,6BAAc,GAAG;IAAQ;;;EAC5D","file":"slice_pipe.ddc.js"}');
  // Exports:
  return {
