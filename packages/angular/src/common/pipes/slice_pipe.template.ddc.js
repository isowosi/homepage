define(['dart_sdk', 'packages/angular/src/common/pipes/invalid_pipe_argument_exception.template', 'packages/angular/di.template'], function(dart_sdk, invalid_pipe_argument_exception, di) {
  ...
  dart.trackLibraries("packages/angular/src/common/pipes/slice_pipe.template.ddc", {
    "package:angular/src/common/pipes/slice_pipe.template.dart": src__common__pipes__slice_pipe$46template
  }, '{"version":3,"sourceRoot":"","sources":["slice_pipe.template.dart"],"names":[],"mappings":";;;;;;;;;;MAaI,kDAAQ;YAAG;;;;;AAEb,kBAAI,kDAAQ,GAAE;AACZ;;AAEF,yDAAW;AAEX,IAAM,4EAAa;AACnB,IAAM,2BAAa;EACrB","file":"slice_pipe.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=slice_pipe.template.ddc.js.map
