define(['dart_sdk', 'packages/angular/core.template', 'packages/angular/src/core/change_detection/differs/default_iterable_differ.template', 'packages/angular/src/core/change_detection/differs/default_keyvalue_differ.template', 'packages/angular/src/runtime.template'], function(dart_sdk, core, default_iterable_differ, default_keyvalue_differ, runtime) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["ng_class.template.dart"],"names":[],"mappings":";;;;;;;;;;;;MAiBI,qDAAQ;YAAG;;;;;AAEb,kBAAI,qDAAQ,GAAE;AACZ;;AAEF,4DAAW;AAEX,IAAM,6BAAa;AACnB,IAAM,sFAAa;AACnB,IAAM,sFAAa;AACnB,IAAM,qCAAa;EACrB","file":"ng_class.template.ddc.js"}');
  // Exports:
  return {
