define(['dart_sdk', 'packages/angular/src/core/change_detection/differs/default_iterable_differ.template', 'packages/angular/src/core/linker.template', 'packages/angular/core.template', 'packages/angular/src/runtime.template'], function(dart_sdk, default_iterable_differ, linker, core, runtime) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["ng_for.template.dart"],"names":[],"mappings":";;;;;;;;;;;;MAgBI,mDAAQ;YAAG;;;;;AAEb,kBAAI,mDAAQ,GAAE;AACZ;;AAEF,0DAAW;AAEX,IAAM,sFAAa;AACnB,IAAM,0CAAa;AACnB,IAAM,6BAAa;AACnB,IAAM,qCAAa;EACrB","file":"ng_for.template.ddc.js"}');
  // Exports:
  return {
