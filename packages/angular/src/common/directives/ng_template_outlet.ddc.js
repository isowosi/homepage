define(['dart_sdk', 'packages/angular/src/core/metadata/lifecycle_hooks', 'packages/angular/src/core/change_detection/host'], function(dart_sdk, lifecycle_hooks, host) {
  'use strict';
