define(['dart_sdk', 'packages/angular/src/core/change_detection/differs/default_iterable_differ', 'packages/angular/src/core/change_detection/host', 'packages/angular/src/runtime/optimizations', 'packages/angular/src/core/metadata/lifecycle_hooks'], function(dart_sdk, default_iterable_differ, host, optimizations, lifecycle_hooks) {
  'use strict';
  ...
  const src__core__linker__view_ref = host.src__core__linker__view_ref;
    ...
    [_applyChanges](changes) {
      ...
      changes.forEachOperation(dart.fn((item, adjustedPreviousIndex, currentIndex) => {
        if (item.previousIndex == null) {
          ...
          let tuple = new src__common__directives__ng_for.RecordViewTuple.new(item, src__runtime__optimizations.unsafeCast(src__core__linker__view_ref.EmbeddedViewRef, view));
          insertTuples[$add](tuple);
        }
      }, CollectionChangeRecordAndintAndintToNull()));
      for (let i = 0; i < dart.notNull(insertTuples[$length]); i++) {
        this[_perViewChange](insertTuples[$_get](i).view, src__runtime__optimizations.unsafeCast(src__core__change_detection__differs__default_iterable_differ.CollectionChangeRecord, insertTuples[$_get](i).record));
      }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["ng_for.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;gBAyGc,KAAK;AACf,YACI,AAAc,KAAT,IAAI,yBAAQ,KAAK,sBACtB,yBAAe,KAAK,OAAI,oDAAK,8CAC7B;AACJ,oBAAQ,oBAAG,KAAK;AAChB,UAAI,aAAO,IAAI,QAAQ,KAAK,IAAI,MAAM;AACpC,qBAAO,GAAG,IAAI,uFAAqB,CAAC,mBAAa;;IAErD;sBAGkB,KAAiB;AACjC,UAAI,KAAK,IAAI,MAAM;AACjB,0BAAY,GAAG,KAAK;;IAExB;qBAMiB,KAAe;AAC9B,yBAAa,GAAG,KAAK;AACrB,UAAI,cAAQ,IAAI,MAAM;AACpB,YAAI,aAAO,IAAI,MAAM;AACnB,uBAAO,GAAG,IAAI,uFAAqB,CAAC,mBAAa;eAC5C;AACL,uBAAO,GAAG,aAAO,MAAM,CAAC,mBAAa;;;IAG3C;;AAIE,UAAI,aAAO,IAAI,MAAM;AACnB,YAAI,UAAU,aAAO,KAAK,CAAC,cAAQ;AACnC,YAAI,OAAO,IAAI,MAAM,mBAAa,CAAC,OAAO;;IAE9C;oBAEmB,OAA6B;AAI9C,UAAM,eAAe;AACrB,aAAO,iBAAiB,CAAC,SAAC,IAA2B,EACjD,qBAAyB,EAAE,YAAgB;AAC7C,YAAI,IAAI,cAAc,IAAI,MAAM;AAC9B,cAAI,OACA,oBAAc,mBAAmB,CAAC,kBAAY,EAAE,YAAY;AAChE,cAAI,QAAQ,IAAI,mDAAe,CAAC,IAAI,EAAE,IAAI;AAC1C,sBAAY,MAAI,CAAC,KAAK;cACjB,KAAI,YAAY,IAAI,MAAM;AAC/B,8BAAc,OAAO,CAAC,qBAAqB;eACtC;AACL,cAAQ,OAAO,oBAAc,IAAI,CAAC,qBAAqB;AACvD,8BAAc,KAAK,CAAC,IAAI,EAAE,YAAY;AACtC,cAAgB,QAAQ,IAAI,mDAAe,CAAC,IAAI,EAAE,sCAAU,8CAAC,IAAI;AACjE,sBAAY,MAAI,CAAC,KAAK;;;AAI1B,eAAS,IAAI,GAAG,AAAE,CAAD,gBAAG,YAAY,SAAO,GAAE,CAAC,IAAI;AAC5C,4BAAc,CAAC,YAAY,QAAC,CAAC,MAAM,EAAE,sCAAU,uFAAC,YAAY,QAAC,CAAC,QAAQ;;AAExE,eAAS,IAAI,GAAG,MAAM,oBAAc,OAAO,EAAE,AAAE,CAAD,gBAAG,GAAG,GAAE,CAAC,IAAI;AACzD,YAAI,UAAU,oBAAc,IAAI,CAAC,CAAC;AAClC,eAAO,SAAS,CAAC,SAAS,AAAU,CAAC,KAAE;AACvC,eAAO,SAAS,CAAC,QAAQ,AAAU,CAAC,KAAM,aAAJ,GAAG,IAAG;AAC5C,eAAO,SAAS,CAAC,SAAS,CAAC;AAC3B,eAAO,SAAS,CAAC,SAAS,GAAG;;AAE/B,aAAO,sBAAsB,CAAC,QAAC,MAAM;AACnC,YAAI,UAAU,oBAAc,IAAI,CAAC,MAAM,aAAa;AACpD,eAAO,SAAS,CAAC,aAAc,MAAM,KAAK;;IAE9C;qBAEoB,IAAoB,EAAE,MAA6B;AACrE,UAAI,SAAS,CAAC,aAAc,MAAM,KAAK;AACvC,UAAI,SAAS,CAAC,QAAQ,MAAM,aAAa,SAAO;AAChD,UAAI,SAAS,CAAC,OAAO,MAAM,aAAa,QAAM;IAChD;;wDAtFW,aAAc,EAAO,WAAY;IALtB,aAAO;IACpB,cAAQ;IACP,mBAAa;IAGZ,oBAAc,GAAd,aAAc;IAAO,kBAAY,GAAZ,WAAY;EAAC;;;;;;;;;;;;;;;;;;;;;;;;IA0FvB;;;;;;IACR;;;;;;;kEACE,MAAW,EAAE,IAAS;IAAjB,aAAM,GAAN,MAAM;IAAO,WAAI,GAAJ,IAAI;EAAC","file":"ng_for.ddc.js"}');
  // Exports:
  return {
