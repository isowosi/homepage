define(['dart_sdk', 'packages/angular/src/core/change_detection/differs/default_iterable_differ', 'packages/angular/src/core/change_detection/differs/default_keyvalue_differ', 'packages/angular/src/runtime/optimizations', 'packages/angular/src/core/metadata/lifecycle_hooks'], function(dart_sdk, default_iterable_differ, default_keyvalue_differ, optimizations, lifecycle_hooks) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["ng_class.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;uBAgEqB,CAAQ;AACzB,gCAAyB,CAAC;AAC1B,2BAAoB,UAAG,CAAC,eAAa,CAAC,QAAM,CAAC,OAAO;AACpD,gCAAyB,CAAC;AAC1B,yBAAkB,CAAC,eAAc,EAAE;IACrC;iBAII,CAAmF;AACrF,2BAAoB,CAAC,eAAc;AACnC,iBAAI,CAAC,cAAY;AACf,SAAC,cAAG,CAAC,YAAO;;AAEd,qBAAc,GAAG,CAAC;AAClB,2BAAoB,GAAG;AACvB,2BAAoB,GAAG;AACvB,UAAI,CAAC,IAAI,MAAM;AACb,6BAAI,CAAC,GAAc;AACjB,+BAAe,GAAG,IAAI,uFAAqB;eACtC;AACL,+BAAe,GAAG,IAAI,uFAAqB;;;IAGjD;;AAIE,UAAI,qBAAe,IAAI,MAAM;AAC3B,YAAI,UAAU,qBAAe,KAAK,CAAC,sCAAU,gBAAC,eAAS;AACvD,YAAI,OAAO,IAAI,MAAM;AACnB,qCAAqB,CAAC,OAAO;;;AAGjC,UAAI,qBAAe,IAAI,MAAM;AAC3B,YAAI,UAAU,qBAAe,KAAK,CAAC,sCAAU,WAAC,eAAS;AACvD,YAAI,OAAO,IAAI,MAAM;AACnB,qCAAqB,CAAC,OAAO;;;IAGnC;;AAIE,2BAAe,CAAC,eAAS;IAC3B;sBAEqB,WAAwC;AAC3D,yBAAa,CAAC,WAAW,EAAE;AAC3B,gCAAoB,CAAC;IACvB;4BAE2B,OAA6B;AACtD,aAAO,iBAAiB,CAAC,QAAC,MAA2B;AACnD,0BAAY,CAAC,sCAAU,cAAC,MAAM,IAAI,GAAG,sCAAU,YAAC,MAAM,aAAa;;AAErE,aAAO,mBAAmB,CAAC,QAAC,MAA2B;AACrD,0BAAY,CAAC,sCAAU,cAAC,MAAM,IAAI,GAAG,sCAAU,YAAC,MAAM,aAAa;;AAErE,aAAO,mBAAmB,CAAC,QAAC,MAA2B;AACrD,YAAI,MAAM,cAAc,IAAI,MAAM;AAChC,4BAAY,CAAC,sCAAU,cAAC,MAAM,IAAI,GAAG;;;IAG3C;4BAE2B,OAA6B;AACtD,aAAO,iBAAiB,CAAC,QAAC,MAA6B;AACrD,0BAAY,CAAC,sCAAU,cAAC,MAAM,KAAK,GAAG;;AAExC,aAAO,mBAAmB,CAAC,QAAC,MAA6B;AACvD,0BAAY,CAAC,sCAAU,cAAC,MAAM,KAAK,GAAG;;IAE1C;2BAE0B,SAAc;AACtC,eAAS,YAAa,sBAAe,EAAE;AACrC,0BAAY,CAAC,SAAS,EAAE,WAAC,SAAS;;IAEtC;oBAOmB,WAAwC,EAAE,SAAc;AACzE,UAAI,WAAW,IAAI,MAAM;AACvB,yBAAI,WAAW,GAAU;AACvB,mBAAS,IAAI,GAAG,MAAM,WAAW,SAAO,EAAE,AAAE,CAAD,gBAAG,GAAG,GAAE,CAAC,IAAI;AACtD,8BAAY,CAAC,sCAAU,cAAC,WAAW,QAAC,CAAC,IAAI,WAAC,SAAS;;cAEhD,sBAAI,WAAW,GAAc;AAClC,mBAAS,YAAa,YAAW,EAAE;AACjC,8BAAY,CAAC,sCAAU,cAAC,SAAS,GAAG,WAAC,SAAS;;eAE3C;AACL,sBAAC,WAAW,WAAgB,CAAC,SAAC,SAAS,EAAE,MAAM;AAC7C,gBAAI,MAAM,IAAI,MAAM;AAClB,gCAAY,CAAC,sCAAU,cAAC,SAAS,GAAG,WAAC,SAAS;;;;;IAKxD;mBAEkB,SAAgB,EAAE,OAAY;AAC9C,eAAS,GAAG,SAAS,OAAK;AAC1B,UAAI,SAAS,UAAQ,EAAE;AACvB,UAAQ,KAAK,WAAK;AAClB,UAAI,YAAY,EAAE,UAAQ;AAC1B,UAAI,AAAuB,SAAd,UAAQ,CAAC,OAAO,CAAC,GAAG;AAC/B,oEAAU;oBAAV,oDAAU,GAAK,AAAI,eAAM,CAAC;AAC1B,YAAI,UAAU,SAAS,QAAM,CAAC,oDAAU;AACxC,iBAAS,IAAI,GAAG,MAAM,OAAO,SAAO,EAAE,AAAE,CAAD,gBAAG,GAAG,GAAE,CAAC,IAAI;AAClD,wBAAI,OAAO,GAAE;AACX,qBAAS,IAAI,CAAC,OAAO,QAAC,CAAC;iBAClB;AACL,qBAAS,OAAO,CAAC,OAAO,QAAC,CAAC;;;aAGzB;AACL,sBAAI,OAAO,GAAE;AACX,mBAAS,IAAI,CAAC,SAAS;eAClB;AACL,mBAAS,OAAO,CAAC,SAAS;;;IAGhC;;4DAnIa,IAAK;IAJI,qBAAe;IACf,qBAAe;IACxB,qBAAe,GAAG;IACvB,eAAS;IACJ,WAAK,GAAL,IAAK;EAAC;;;;;;;;;;;;;;;;;;;;;;;;;;;;MANL,oDAAU","file":"ng_class.ddc.js"}');
  // Exports:
  return {
