define(['dart_sdk', 'packages/angular/src/security/dom_sanitization_service_impl', 'packages/angular/src/di/reflector', 'packages/angular/src/core/di.template', 'packages/angular/src/core/security.template', 'packages/angular/src/security/dom_sanitization_service.template', 'packages/angular/src/security/html_sanitizer.template', 'packages/angular/src/runtime.template', 'packages/angular/src/security/style_sanitizer.template', 'packages/angular/src/security/url_sanitizer.template'], function(dart_sdk, dom_sanitization_service_impl, reflector, di, security, dom_sanitization_service, html_sanitizer, runtime, style_sanitizer, url_sanitizer) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["dom_sanitization_service_impl.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;MAuBI,gEAAQ;YAAG;;;;;AAEb,kBAAI,gEAAQ,GAAE;AACZ;;AAEF,uEAAW;AAEX,IAAO,kCAAe,CAAC,sFAA0B,EAAE,cAAM,IAAI,2EAA0B;AACvF,IAAM,sCAAa;AACnB,IAAM,4CAAa;AACnB,IAAM,gEAAa;AACnB,IAAM,sDAAa;AACnB,IAAM,qCAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,qDAAa;EACrB","file":"dom_sanitization_service_impl.template.ddc.js"}');
  // Exports:
  return {
