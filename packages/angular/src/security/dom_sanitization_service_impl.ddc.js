define(['dart_sdk', 'packages/angular/src/core/security', 'packages/angular/src/security/html_sanitizer', 'packages/angular/src/runtime/optimizations', 'packages/angular/src/security/style_sanitizer', 'packages/angular/src/security/url_sanitizer', 'packages/angular/src/security/dom_sanitization_service'], function(dart_sdk, security, html_sanitizer, optimizations, style_sanitizer, url_sanitizer, dom_sanitization_service) {
  'use strict';
