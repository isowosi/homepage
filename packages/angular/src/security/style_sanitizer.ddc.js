define(['dart_sdk', 'packages/angular/src/security/url_sanitizer', 'packages/angular/src/runtime/optimizations'], function(dart_sdk, url_sanitizer, optimizations) {
  'use strict';
  ...
  }, '{"version":3,"sourceRoot":"","sources":["style_sanitizer.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;MAmBM,sCAAO;YAAG;;MACV,kDAAmB;YACrB;;MACE,yCAAU;YAAG;;MACb,uCAAQ;YAAG;;MACX,mCAAI;YAAG;;MAEA,+CAAgB;YACzB,AAAI,gBAAM,CAAC,aAAI,yBAAO,KAAG,qBAAI,GAAC,yBAAO,cAAY,+DAAmB,MAChE,WAAE,eAAU,IAAE,yBAAQ;;MAqBjB,qCAAM;YAAG,AAAI,gBAAM,CAAC;;;8DASV,KAAY;AACjC,QAAM,gBAAgB,gBAAc,CAAC;AACrC,QAAM,sBAAsB,gBAAc,CAAC;AAC3C,QAAK,gBAAgB;AACrB,QAAK,gBAAgB;AACrB,aAAS,IAAI,GAAG,AAAE,CAAD,GAAG,KAAK,OAAO,EAAE,CAAC,IAAI;AACrC,UAAI,IAAI,KAAK,aAAW,CAAC,CAAC;AAC1B,UAAI,CAAC,KAAI,aAAa,IAAI,aAAa,EAAE;AACvC,qBAAa,GAAG,CAAC,aAAa;YACzB,KAAI,CAAC,KAAI,mBAAmB,IAAI,aAAa,EAAE;AACpD,qBAAa,GAAG,CAAC,aAAa;;;AAGlC,UAAO,AAAc,cAAD,IAAI,aAAa;EACvC;kEAE6B,KAAY;AACvC,SAAK,GAAG,KAAK,OAAK;AAClB,QAAI,KAAK,UAAQ,EAAE,MAAO;AAG1B,QAAM,WAAW,qCAAM,WAAW,CAAC,KAAK;AACxC,QAAI,QAAQ,IAAI,MAAM;AACpB,UAAO,QAAQ,QAAQ,MAAM,CAAC;AAC9B,UAAI,gDAAmB,CAAC,KAAK,KAAK,KAAK,EAAE;AACvC,cAAO,MAAK;;UAET,eAAI,+CAAgB,SAAS,CAAC,KAAK,gBAAK,gDAAiB,CAAC,KAAK,IAAG;AACvE,YAAO,MAAK;;AAEd,QAAI,KAAK,WAAS,CAAC,MAAM;AACvB,UAAa,QAAQ,KAAK,QAAM,CAAC;AACjC,UAAK,SAAS;AACd,eAAY,OAAQ,MAAK,EAAE;AACzB,YAAM,WAAW,qCAAM,WAAW,CAAC,IAAI;AACvC,YAAI,QAAQ,IAAI,MAAM;AACpB,cAAO,QAAQ,QAAQ,MAAM,CAAC;AAC9B,cAAI,gDAAmB,CAAC,KAAK,KAAK,KAAK,EAAE;AACvC,kBAAM,GAAG;AACT;;cAEG,OAAM,+CAAgB,SAAS,CAAC,IAAI,MAAK,kBAC5C,gDAAiB,CAAC,IAAI,KAAI;AAC5B,gBAAM,GAAG;AACT;;;AAGJ,WAAK,MAAM,EAAE,MAAO,MAAK;;AAE3B,kBAAI,qCAAS,GAAE;AACb,iBAAM,UAAQ,KAAK,CAAC,yCAAgC,KAAK,MACrD;;AAEN,UAAO;EACT","file":"style_sanitizer.ddc.js"}');
  // Exports:
  return {
