define(['dart_sdk', 'packages/angular/src/core/linker/app_view_utils', 'packages/angular/src/core/security', 'packages/angular/src/platform/dom/events/event_manager', 'packages/angular/src/di/reflector', 'packages/angular/src/core/di/opaque_token', 'packages/angular/src/core/di/decorators', 'packages/angular/src/core/linker/exceptions.template', 'packages/angular/di.template', 'packages/angular/src/core/application_tokens.template', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/src/core/metadata/view.template', 'packages/angular/src/core/render/api.template', 'packages/angular/src/core/security.template', 'packages/angular/src/platform/dom/events/event_manager.template'], function(dart_sdk, app_view_utils, security, event_manager, reflector, opaque_token, decorators, exceptions, di, application_tokens, change_detection, view, api, security$, event_manager$) {
  'use strict';
