define(['dart_sdk', 'packages/angular/src/core/change_detection/component_state', 'packages/angular/src/core/change_detection/host'], function(dart_sdk, component_state, host) {
  'use strict';
