    ...
    diff(collection) {
      if (collection != null) {
        if (!core.Iterable.is(collection)) {
          dart.throw(new core.StateError.new(dart.str`Error trying to diff '${collection}'`));
        }
      } else {
