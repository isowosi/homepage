define(['dart_sdk'], function(dart_sdk) {
  ...
  dart.trackLibraries("packages/angular/src/core/security.template.ddc", {
    "package:angular/src/core/security.template.dart": src__core__security$46template
  }, '{"version":3,"sourceRoot":"","sources":["security.template.dart"],"names":[],"mappings":";;;;;;;;EASsB","file":"security.template.ddc.js"}');
  // Exports:
  return {
