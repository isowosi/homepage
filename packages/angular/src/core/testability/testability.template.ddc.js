define(['dart_sdk', 'packages/angular/src/core/testability/testability', 'packages/angular/src/core/zone/ng_zone', 'packages/angular/src/di/reflector', 'packages/angular/src/core/zone/ng_zone.template', 'packages/angular/src/core/di.template'], function(dart_sdk, testability, ng_zone, reflector, ng_zone$, di) {
  'use strict';
