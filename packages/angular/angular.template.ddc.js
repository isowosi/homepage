define(['dart_sdk', 'packages/angular/core.template', 'packages/angular/src/bootstrap/run.template', 'packages/angular/src/common/common_directives.template', 'packages/angular/src/common/directives.template', 'packages/angular/src/common/pipes.template', 'packages/angular/src/core/application_ref.template', 'packages/angular/src/core/linker.template', 'packages/angular/src/core/testability/testability.template', 'packages/angular/src/platform/browser/tools/tools.template', 'packages/angular/src/platform/dom/events/event_manager.template'], function(dart_sdk, core, run, common_directives, directives, pipes, application_ref, linker, testability, tools, event_manager) {
  'use strict';
