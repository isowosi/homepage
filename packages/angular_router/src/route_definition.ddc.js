define(['dart_sdk', 'packages/angular_router/src/url', 'packages/angular/src/runtime/optimizations', 'packages/angular/src/core/change_detection/host', 'packages/angular/src/core/metadata', 'packages/angular_router/src/location/location'], function(dart_sdk, url, optimizations, host, metadata, location) {
  'use strict';
