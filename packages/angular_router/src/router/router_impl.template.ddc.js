define(['dart_sdk', 'packages/angular_router/src/router/router_impl', 'packages/angular_router/src/location/location', 'packages/angular_router/src/router_hook', 'packages/angular/src/di/reflector', 'packages/angular/src/core/di/decorators', 'packages/angular_router/src/directives/router_outlet_directive.template', 'packages/angular_router/src/lifecycle.template', 'packages/angular_router/src/location.template', 'packages/angular_router/src/route_definition.template', 'packages/angular_router/src/router_hook.template', 'packages/angular_router/src/url.template', 'packages/angular_router/src/router/navigation_params.template', 'packages/angular/angular.template', 'packages/angular_router/src/router/router_state.template'], function(dart_sdk, router_impl, location, router_hook, reflector, decorators, router_outlet_directive, lifecycle, location$, route_definition, router_hook$, url, navigation_params, angular, router_state) {
  'use strict';
