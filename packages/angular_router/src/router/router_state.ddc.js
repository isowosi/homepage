define(['dart_sdk', 'packages/angular_router/src/route_definition', 'packages/angular_router/src/url', 'packages/angular/src/core/change_detection/host'], function(dart_sdk, route_definition, url, host) {
  'use strict';
