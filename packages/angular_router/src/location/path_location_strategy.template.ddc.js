define(['dart_sdk', 'packages/angular_router/src/location/path_location_strategy', 'packages/angular_router/src/location/platform_location', 'packages/angular/src/di/reflector', 'packages/angular/src/core/di/opaque_token', 'packages/angular/src/core/di/decorators', 'packages/angular_router/src/location/location.template', 'packages/angular_router/src/location/location_strategy.template', 'packages/angular/angular.template', 'packages/angular_router/src/location/platform_location.template'], function(dart_sdk, path_location_strategy, platform_location, reflector, opaque_token, decorators, location, location_strategy, angular, platform_location$) {
  'use strict';
  ...
  dart.trackLibraries("packages/angular_router/src/location/path_location_strategy.template.ddc", {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["path_location_strategy.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;MAoBI,yDAAQ;YAAG;;;;;;;;;;;AAEb,kBAAI,yDAAQ,GAAE;AACZ;;AAEF,gEAAW;AAEX,IAAO,kCAAe,CAAC,yEAAoB,EAAE,SAAC,EAAuB,EAAE,EAAS,KAAK,IAAI,8DAAoB,CAAC,EAAE,EAAE,EAAE;AACpH,IAAO,uCAAoB,CAAC,yEAAoB,EAAE,sCAChD,oCAAW,gEAAgB,kBAC3B,sCAAO,qCAAM,oCAAa,CAAC,qCAAM,2BAAuB,CAAC,qBAAiB,qCAAM,sCAAe;AAEjG,IAAM,gDAAa;AACnB,IAAM,yDAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,yDAAa;EACrB","file":"path_location_strategy.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=path_location_strategy.template.ddc.js.map
