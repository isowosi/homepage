define(['dart_sdk', 'packages/angular_router/src/location/base_href', 'packages/angular_router/src/location/platform_location'], function(dart_sdk, base_href, platform_location) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["browser_platform_location.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;AAsBI,qBAAS,GAAG,WAAM,WAAS;AAC3B,oBAAQ,GAAG,WAAM,QAAQ;IAC3B;;YAEyB,gBAAS;;;YAEH,iDAAe;IAAE;eAGhC,EAAgB;AAC9B,iBAAM,mBAAiB,CAAC,YAAY,EAAE,EAAE;IAC1C;iBAGkB,EAAgB;AAChC,iBAAM,mBAAiB,CAAC,cAAc,EAAE,EAAE;IAC5C;;AAGE,YAAO,gBAAS,SAAS;IAC3B;;AAGE,YAAO,gBAAS,OAAO;IACzB;;AAGE,YAAO,gBAAS,KAAK;IACvB;iBAEa,OAAc;AACzB,qBAAS,SAAS,GAAG,OAAO;IAC9B;cAEe,KAAa,EAAE,KAAY,EAAE,GAAU;AACpD,oBAAQ,YAAU,CAAC,KAAK,EAAE,KAAK,EAAE,GAAG;IACtC;iBAEkB,KAAa,EAAE,KAAY,EAAE,GAAU;AACvD,oBAAQ,eAAa,CAAC,KAAK,EAAE,KAAK,EAAE,GAAG;IACzC;;AAGE,oBAAQ,QAAQ;IAClB;;AAGE,oBAAQ,KAAK;IACf;;;IA1DS,eAAS;IACV,cAAQ;AAGd,uDAA4B,iEAAe;AAC3C,eAAK;EACP","file":"browser_platform_location.ddc.js"}');
  // Exports:
  return {
