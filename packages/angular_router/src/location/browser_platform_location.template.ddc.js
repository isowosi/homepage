define(['dart_sdk', 'packages/angular_router/src/location/browser_platform_location', 'packages/angular/src/di/reflector', 'packages/angular_router/src/location/base_href.template', 'packages/angular/angular.template', 'packages/angular_router/src/location/platform_location.template'], function(dart_sdk, browser_platform_location, reflector, base_href, angular, platform_location) {
  'use strict';
