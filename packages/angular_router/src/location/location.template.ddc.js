define(['dart_sdk', 'packages/angular_router/src/location/location', 'packages/angular_router/src/location/location_strategy', 'packages/angular/src/di/reflector', 'packages/angular_router/src/location/location_strategy.template', 'packages/angular/angular.template'], function(dart_sdk, location, location_strategy, reflector, location_strategy$, angular) {
  'use strict';
