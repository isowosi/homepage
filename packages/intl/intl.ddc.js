define(['dart_sdk', 'packages/intl/date_symbols', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data'], function(dart_sdk, date_symbols, plural_rules, number_symbols, number_symbols_data) {
  'use strict';
  ...
  intl.Intl = class Intl extends core.Object {
    ...
    static verifiedLocale(newLocale, localeExists, opts) {
      let onFailure = opts && 'onFailure' in opts ? opts.onFailure : dart.fn(intl.Intl._throwLocaleError, StringToString());
      if (newLocale == null) {
    ...
    static _pluralRule(locale, howMany) {
      ...
      let verifiedLocale = intl.Intl.verifiedLocale(locale, dart.fn(src__plural_rules.localeHasPluralRules, StringTobool()), {onFailure: dart.fn(locale => 'default', dynamicToString())});
  ...
  intl.BidiFormatter = class BidiFormatter extends core.Object {
    ...
    wrapWithSpan(text, opts) {
      ...
      let result = null;
      if (!dart.test(isHtml)) text = (const$2 || (const$2 = dart.const(new convert.HtmlEscape.new()))).convert(text);
  ...
  (intl.NumberFormat._forPattern = function(locale, getPattern, opts) {
    ...
    this[_localeZero] = 0;
    this[_zeroOffset] = 0;
    this[_locale] = intl.Intl.verifiedLocale(locale, dart.fn(intl.NumberFormat.localeExists, dynamicTobool()));
  ...
  (intl._CompactNumberFormat.new = function(opts) {
    ...
    let name = opts && 'name' in opts ? opts.name : null;
    let currencySymbol = opts && 'currencySymbol' in opts ? opts.currencySymbol : null;
    let getPattern = opts && 'getPattern' in opts ? opts.getPattern : dart.fn(intl._CompactNumberFormat._forDecimal, NumberSymbolsToString());
    let computeCurrencySymbol = opts && 'computeCurrencySymbol' in opts ? opts.computeCurrencySymbol : null;
    let decimalDigits = opts && 'decimalDigits' in opts ? opts.decimalDigits : null;
    let isForCurrency = opts && 'isForCurrency' in opts ? opts.isForCurrency : false;
    this[_patterns] = null;
  ...
  (intl.DateFormat.new = function(newPattern, locale) {
    ...
    this[_localeZeroCodeUnit] = null;
    this[_localeZero] = null;
    this[_locale] = intl.Intl.verifiedLocale(locale, dart.fn(intl.DateFormat.localeExists, dynamicTobool()));
