define(['dart_sdk', 'packages/stack_trace/src/utils', 'packages/path/path'], function(dart_sdk, utils, path) {
  ...
  dart.setMethodSignature(src__lazy_chain.LazyChain, () => ({
    ...
    foldFrames: dart.fnType(src__chain.Chain, [dart.fnType(core.bool, [src__frame.Frame])], {terse: core.bool}),
  ...
  dart.setGetterSignature(src__lazy_chain.LazyChain, () => ({
    ...
    [_chain]: src__chain.Chain,
    traces: core.List$(src__trace.Trace),
    terse: src__chain.Chain
  }));
  ...
  src__chain.Chain = class Chain extends core.Object {
    ...
    toString() {
      let longest = this.traces[$map](core.int, dart.fn(trace => trace.frames[$map](core.int, dart.fn(frame => frame.location.length, FrameToint()))[$fold](core.int, 0, dart.gbind(dart.fn(math.max, TAndTToT()), core.int)), TraceToint()))[$fold](core.int, 0, dart.gbind(dart.fn(math.max, TAndTToT()), core.int));
  ...
  dart.setMethodSignature(src__lazy_trace.LazyTrace, () => ({
    ...
    foldFrames: dart.fnType(src__trace.Trace, [dart.fnType(core.bool, [src__frame.Frame])], {terse: core.bool})
  }));
  dart.setGetterSignature(src__lazy_trace.LazyTrace, () => ({
    __proto__: dart.getGetters(src__lazy_trace.LazyTrace.__proto__),
    [_trace]: src__trace.Trace,
    frames: core.List$(src__frame.Frame),
    original: core.StackTrace,
    vmTrace: core.StackTrace,
    terse: src__trace.Trace
  }));
  ...
  src__trace.Trace = class Trace extends core.Object {
    ...
    toString() {
      let longest = this.frames[$map](core.int, dart.fn(frame => frame.location.length, FrameToint()))[$fold](core.int, 0, dart.gbind(dart.fn(math.max, TAndTToT()), core.int));
      return this.frames[$map](core.String, dart.fn(frame => {
